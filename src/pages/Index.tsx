    ...
    <div className="flex flex-col min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white">    
      <main className="flex-1">
        ...
        <section
          ...
          style={{
            backgroundImage: "url('/src/Assets/dotted_page.png')",
        ...
        >
          ...
          <div className="container mx-auto" style={{display:'flex',justifyContent:'center'}}>
            ...
            <h1 className="text-2xl md:text-7xl font-black leading-tight text-black drop-shadow-lg mb-6">
              Transform PDFs into Interactive Learning Roadmaps
            </h1>
            <p className="mt-4 text-lg md:text-2xl text-black max-w-2xl mx-auto mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
              <div className="group relative inline-block p-[2px] rounded-lg bg-gradient-to-r from-blue-600 via-blue-400 to-gray-400 animate-border transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 hover:scale-105">
                <Button size="lg" className="relative z-10 px-8 py-5 min-w-[180px] bg-black text-white hover:bg-gray-900 rounded-lg font-bold shadow transition-all duration-300" asChild>
                <Link to="/upload">
